from src.api_connection import (FindEmployerFromHHApi,
                                  FindVacancyFromHHApi)
from src.db_create import DBConnection
...
def user_interaction_with_db():
    ...
    # Проверяем, существует ли база, и создаем её, если нужно
    if not db_connect.database_exists():
